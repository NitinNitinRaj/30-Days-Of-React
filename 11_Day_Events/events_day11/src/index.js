...
import MouseEventGame from "./components/MouseEventGame";
...
class App extends Component {
  ...
  handleMouseMove = (e) => {
    this.setState({
      message: `mouse is moving, mouse is at X:${e.clientX} | y:${e.clientY}`,
    });
  };
...
ReactDOM.render(<MouseEventGame />, rootElement);
